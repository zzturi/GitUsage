...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) 
    {
        self.webView = [[[UIWebView alloc] initWithFrame:CGRectMake(-10, 34, 320, 439)] autorelease];
        [self.webView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"bgImage.png"]]];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    NSURL *loginURL = [NSURL URLWithString:@"http://graph.renren.com/login"];
    if ([url isEqual:loginURL])
    {
...
- (void)show
{
    ...
    //self.serverURL = http://graph.renren.com/oauth/authorize
