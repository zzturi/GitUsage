...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 44, 320, 432)])
    {
//        // background settings
...
//        [panelView addSubview:containerView];
        ...
        webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 320, 452)];
        [webView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"bgImage.png"]]];
        [webView setDelegate:self];
