...
- (id)init {
    ...
    [_webView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"bgImage.png"]]];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request
 navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([[url absoluteString] hasPrefix:kRedirectURL])
    {
        ...
        {
            NSString * errorCode = [KaixinDialog getStringFromUrl:[url absoluteString] 
                                                           needle:@"error_code="];
            NSString * errorStr = [KaixinDialog getStringFromUrl:[url absoluteString] 
                                                          needle:@"error_msg="];
            if (errorCode) 
            {
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kShowKaiXinActivityView 
                                                        object:kShowView];
...
- (void)loadURL:(NSString*)url get:(NSDictionary*)getParams {
  ...
  [_loadingURL release];
  _loadingURL = [[KaixinDialog generateURL:url params:getParams] retain];
...
- (void)show{
  ...
  _closeButton.frame = CGRectMake(self.frame.size.width - kBorderWidth - 2, 1, kBorderWidth, kBorderWidth-1);
